...
if("FALSE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /home/kalyco/mfp_workspace/src/apriltags_ros/apriltags)
  set(apriltags_DEVEL_PREFIX /home/kalyco/mfp_workspace/devel/.private/apriltags)
  ...
  set(apriltags_INSTALL_PREFIX /home/kalyco/mfp_workspace/install)
...
if(NOT "include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kalyco/mfp_workspace/install/${idir}'.  ${_report}")
    endif()
