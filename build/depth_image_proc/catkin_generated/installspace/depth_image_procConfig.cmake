...
if("FALSE" STREQUAL "TRUE")
  set(depth_image_proc_SOURCE_PREFIX /home/kalyco/mfp_workspace/src/image_pipeline/depth_image_proc)
  set(depth_image_proc_DEVEL_PREFIX /home/kalyco/mfp_workspace/devel/.private/depth_image_proc)
  ...
  set(depth_image_proc_INSTALL_PREFIX /home/kalyco/mfp_workspace/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kalyco/mfp_workspace/install/${idir}'.  ${_report}")
    endif()
