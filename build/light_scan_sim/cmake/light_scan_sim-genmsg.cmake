...
set(MSG_I_FLAGS "-Ilight_scan_sim:/home/kalyco/mfp_workspace/src/light_scan_sim/msg;-Istd_msgs:/home/kalyco/mfp_workspace/src/std_msgs/msg")
...
get_filename_component(_filename "/home/kalyco/mfp_workspace/src/light_scan_sim/msg/SegmentList.msg" NAME_WE)
add_custom_target(_light_scan_sim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "light_scan_sim" "/home/kalyco/mfp_workspace/src/light_scan_sim/msg/SegmentList.msg" "light_scan_sim/Segment"
)

get_filename_component(_filename "/home/kalyco/mfp_workspace/src/light_scan_sim/msg/Material.msg" NAME_WE)
add_custom_target(_light_scan_sim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "light_scan_sim" "/home/kalyco/mfp_workspace/src/light_scan_sim/msg/Material.msg" ""
)

get_filename_component(_filename "/home/kalyco/mfp_workspace/src/light_scan_sim/msg/Segment.msg" NAME_WE)
add_custom_target(_light_scan_sim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "light_scan_sim" "/home/kalyco/mfp_workspace/src/light_scan_sim/msg/Segment.msg" ""
)

get_filename_component(_filename "/home/kalyco/mfp_workspace/src/light_scan_sim/msg/MaterialList.msg" NAME_WE)
add_custom_target(_light_scan_sim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "light_scan_sim" "/home/kalyco/mfp_workspace/src/light_scan_sim/msg/MaterialList.msg" "light_scan_sim/Material"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/light_scan_sim)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/light_scan_sim\")")
  # install generated code
  install(
