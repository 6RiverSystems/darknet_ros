...
if("FALSE" STREQUAL "TRUE")
  set(pcl_ros_SOURCE_PREFIX /home/kalyco/mfp_workspace/src/perception_pcl/pcl_ros)
  set(pcl_ros_DEVEL_PREFIX /home/kalyco/mfp_workspace/devel/.private/pcl_ros)
  set(pcl_ros_INSTALL_PREFIX "")
  set(pcl_ros_PREFIX ${pcl_ros_DEVEL_PREFIX})
else()
  set(pcl_ros_SOURCE_PREFIX "")
  set(pcl_ros_DEVEL_PREFIX "")
  set(pcl_ros_INSTALL_PREFIX /home/kalyco/mfp_workspace/install)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcl_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kalyco/mfp_workspace/install/${idir}'.  ${_report}")
    endif()
