...
if("FALSE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/kalyco/mfp_workspace/src/image_pipeline/image_proc)
  set(image_proc_DEVEL_PREFIX /home/kalyco/mfp_workspace/devel/.private/image_proc)
  ...
  set(image_proc_INSTALL_PREFIX /home/kalyco/mfp_workspace/install)
...
if(NOT "include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kalyco/mfp_workspace/install/${idir}'.  ${_report}")
    endif()
