...
if("FALSE" STREQUAL "TRUE")
  set(pcl_conversions_SOURCE_PREFIX /home/kalyco/mfp_workspace/src/pcl_conversions)
  set(pcl_conversions_DEVEL_PREFIX /home/kalyco/mfp_workspace/devel/.private/pcl_conversions)
  ...
  set(pcl_conversions_INSTALL_PREFIX /home/kalyco/mfp_workspace/install)
...
if(NOT "include;/usr/include/eigen3;/usr/include;/usr/include/pcl-1.8 " STREQUAL " ")
  set(pcl_conversions_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/eigen3;/usr/include;/usr/include/pcl-1.8")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcl_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kalyco/mfp_workspace/install/${idir}'.  ${_report}")
    endif()
